...
import ants.tests
from ants.fileformats.ancil import load_cubes_32bit_ieee


class TestAll(ants.tests.TestCase):
    def setUp(self):
        patch = mock.patch("iris.fileformats.um.load_cubes_32bit_ieee")
    ...
    def test_iris_call(self):
        load_cubes_32bit_ieee(mock.sentinel.dummy)
