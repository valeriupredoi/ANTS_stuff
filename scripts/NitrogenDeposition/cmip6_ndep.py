...
hadgem3File = (
    "/hpc/projects/um1/ancil/atmos/n96e/orca1/land_sea_mask/etop01/v0/qrparm.mask"
)
# hadgem2File = "/hpc/projects/um1/hg6.6.6/ctldata/ancil/qrparm.mask"
gridFile = hadgem3File
stash = "m01s00i447"
pi_ancil_name = "/data/users/eroberts/HADGEM_ANCIL/CMIP6/NDEP/ndep_input4MIPs_surfaceFluxes_CMIP_NCAR-CCMI-1-0_gr_185001-185012.n96.anc"
hist_ancil_name = "/data/users/eroberts/HADGEM_ANCIL/CMIP6/NDEP/ndep_input4MIPs_surfaceFluxes_CMIP_NCAR-CCMI-1-0_gr_185001-201412.n96.anc"
piSwitch = False
histSwitch = True
...
def main():
    ...
    if piSwitch:
        ...
        ants.utils.guess_bounds(piCube.coord("time"), strict=True)
        print(piCube)
    ...
    if histSwitch:
        ...
        ants.utils.guess_bounds(histCube.coord("time"), strict=True)
        print(histCube)
...
def regrid(inCube):  # ,gridCube):
    ...
    ants.utils.guess_horizontal_bounds(inCube)
    ants.utils.guess_horizontal_bounds(gridCube)
