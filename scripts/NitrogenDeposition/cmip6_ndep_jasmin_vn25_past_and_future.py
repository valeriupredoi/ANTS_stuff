...
#
# 29th January 2019: THis script worked for an example historical ancillary - will fcm commit after adding this comment. (BECAME REV 7226)
#
# python2.7 cmip6_ndep_jasmin_vn25_past_and_future.py -s './TESTDIR_N96E/drynhx_input4MIPs_surfaceFluxes_CMIP_NCAR-CCMI-2-0_gn_185001-201412.nc'
#  './TESTDIR_N96E/drynoy_input4MIPs_surfaceFluxes_CMIP_NCAR-CCMI-2-0_gn_185001-201412.nc' './TESTDIR_N96E/wetnhx_input4MIPs_surfaceFluxes_CMIP_NCAR-CCMI-2-0_gn_185001-201412.nc'
#  './TESTDIR_N96E/wetnoy_input4MIPs_surfaceFluxes_CMIP_NCAR-CCMI-2-0_gn_185001-201412.nc' --resolution  './TESTDIR_N96E_SSP585/qrparm.mask_n96e_eorca1_v2.2x_ESMF'
#   -o './TESTDIR_JAN2019/Ndep_n96e_1871_1905_appended' -n 'Ndep' --begin 1871 --end 1905
#
# The resulting file Ndep_n96e_1871_1905_appended looks identical to the appropriate years in:
...
# This command then produced a SSP126 which matched the one in TESTDIR_SSP126 but the plots were odd - anc curve started at zero, raw off to the right SAVED AS REV 7227:
# python2.7 cmip6_ndep_jasmin_vn25_past_and_future.py -s './TESTDIR_N96E_SSP126/drynhx_input4MIPs_surfaceFluxes_ScenarioMIP_NCAR-CCMI-ssp126-1-0_gn_201501-209912.nc'
...
#    './TESTDIR_N96E_SSP126/wetnoy_input4MIPs_surfaceFluxes_ScenarioMIP_NCAR-CCMI-ssp126-2-0_gn_201501-209912.nc' --resolution
#    './TESTDIR_N96E_SSP126/qrparm.mask_n96e_eorca1_v2.2x_ESMF' -o './TESTDIR_JAN2019/Ndep_n96e_ssp126_2034_2056' -n 'Ndep' --begin 2034 --end 2056
    ...
    if type == "timeseries":
        ...
        if (
            ...
            if (pastOrFuture) == "past":  # This worked for the 1871 1905 example
                ...
                # Build the points from the first value of the oriignal points, which was from a 365 day calendar, and the midpoint of January is
                # 15.5 days through it, so integer part of it to get the number of days from the start date.
                firstDate = int(tseriesCubeRG_out.coord("time").points[0])
                #             tseriesCubeRG_out.coord('time').points = [ firstDate + i*30 +15  for i in range(len(tseriesCubeRG_out.coord('time').points)) ]
