...
def main():
    ...
    if type == "timeseries":
        ...
        tseriesCube.coord("time").points = tseriesCube.coord("time").points * 30.0
        ...
        if (
            ...
            with iris.FUTURE.context(cell_datetime_objects=True):
                ...
                print "args.start, args.end  = ", args.begin, args.end
    ...
    # if appendHeadTail:
    #   plot_ndep_anc(tseriesCubes_startm1_to_endp1_cc[:],tseriesCubeRG_out,["Input4MIPs","Ancil."])
    # else:
